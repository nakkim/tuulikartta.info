    ...
    (function (H, onSeriesMixin) {
         ...
         */
             ...
             */
                 ...
                 */
                    pointFormat: '<span style="color:{point.color}">\u25CF</span> {series.name}: <b>{point.direction}</b> ({point.beaufort})<br/>'
                },
                /**
             ...
             */
                ...
                beaufortName: ['Tyyntä', 'Heikkoa tuulta', 'Kohtalaista tuulta', 
                    'Navakkaa tuulta', 'Kovaa tuulta', 'Myrskyä', 'Kovaa myrskyä', 'Ankaraa myrskyä',
                    'Hirmumyrskyä'],
                // beaufortFloor: [0, 0.3, 1.6, 3.4, 5.5, 8.0, 10.8, 13.9, 17.2, 20.8,
                //     24.5, 28.5, 32.7],
                beaufortFloor: [0, 1, 3, 8, 14, 21, 25, 29, 32],
