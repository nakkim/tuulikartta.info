...
var translations = {
  'fi': {
    ...
    'windParticlesTitle': 'Näytä tuulianimaatio',
    'windDirectionLabel': 'suunta',
    'windSpeedLabel': 'nopeus',
    'roadObs': 'Näytä tiesäähavainnot',
    'renderSettings': 'Piirtoasetukset',
    'useWindBarbs': 'Käytä tuulinuolia',
    'showDivergence': 'Näytä konvergenssi (sininen) ja divergenssi (punainen)',
    'notificationReadMore': 'Lue lisää',
    'settings': 'Asetukset',
    ...
    'smartsymbol': 'Sääsymboli',
    'pressure': 'Ilmanpaine',
    'rh': 'Suhteellinen kosteus',
    'snow_aws': 'Lumensyvyys',
    'synopplot': 'Synop-symboli',
    'search': 'Hae',
    'now': 'Nyt',
  ...
  'en': {
    ...
    'renderSettings': 'Display settings',
    'useWindBarbs': 'Use wind barbs',
    'showDivergence': 'Show convergence (blue) and divergence (red)',
    'notificationReadMore': 'Read more',
    'settings': 'Settings',
